...
// ─── Esquema base (compartido entre crear y editar) ───────────────────────────

const baseTipoCosteoSchema = z.object({
...
export const crearTipoCosteoSchema = baseTipoCosteoSchema

export const editarTipoCosteoSchema = baseTipoCosteoSchema.and(
  z.object({
